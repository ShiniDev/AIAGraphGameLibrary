...
class DebugDrawLine extends Node
{
    ...
    public Port $inputFloat_Duration; // Inferred from typical debug drawing functions
    ...
    public function __construct(Graph $graph, string $modifier = '')
    {
        ...
        $this->inputFloat_Duration = new Port($graph, 'Float1', 'float', 0, 1, new Color(0.8666666746139526, 0.8078431487083435, 0.0)); // Assuming a duration input
        ...
        $this->addPort($this->inputFloat_Duration, new Vector2(-266.1, -175.0));
    ...
    public function connectDuration(Port $port): self
    {
        $port->connectTo($this->inputFloat_Duration);
        return $this;
    }
