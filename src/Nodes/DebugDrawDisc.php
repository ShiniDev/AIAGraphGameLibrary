...
class DebugDrawDisc extends Node
{
    ...
    public Port $inputFloat_Duration; // Inferred
    ...
    public function __construct(Graph $graph, string $modifier = '')
    {
        ...
        $this->inputFloat_Duration = new Port($graph, 'Float2', 'float', 0, 1, new Color(0.8666666746139526, 0.8078431487083435, 0.0)); // Assuming a duration input
